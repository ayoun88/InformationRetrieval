...
<p align="Left">
  <img src="assets/EDA_duplicated.png" width="1000">
</p>
...
| 문제 | 원인 | 해결 |
|------|------|------|
| **ES root 권한 거부** | Elasticsearch는 보안상 root로 실행 불가 | `chown -R 1:1 ./elasticsearch-8.8.0`으로 소유권 이전 후 재실행, 또는 다른 디렉토리에서 실행 |
